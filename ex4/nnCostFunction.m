...
% feedforward
a1 = [ones(m, 1) X];  % add 1 as a bias for every input parameter's first element (5000 x 401)
z2 = a1*Theta1';      % calculate the weight of every neuron on the 2nd (hidden) layer 
a2 = [ones(m, 1) sigmoid(z2)]; % calculate sigmoid for 2nd layer and add 1 as bias for every input (5000 x 26)
...
delta2 = delta2(:, 2:end); % remove first element, we don't calculate delta from bias

% accumulate the gradients
delta_layer_1 = (delta2' * a1);
